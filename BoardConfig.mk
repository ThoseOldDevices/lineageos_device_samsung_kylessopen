...
# Kernel
TARGET_KERNEL_CONFIG := lineage_kyle03_defconfig
...
BOARD_GLOBAL_CFLAGS += -DQCOM_DIRECTTRACK
BOARD_GLOBAL_CPPFLAGS += -DQCOM_DIRECTTRACK
...
BOARD_GLOBAL_CFLAGS += -DICS_CAMERA_BLOB -DSAMSUNG_CAMERA_LEGACY -DNEEDS_VECTORIMPL_SYMBOLS
